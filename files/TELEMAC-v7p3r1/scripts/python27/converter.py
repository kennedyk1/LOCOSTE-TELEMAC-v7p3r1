...
def add_bnd(inputFile):
   ...
   m0D = meshFile2D.getMeshAtLevel(-2)
   ...
   for groupName in meshFile2D.getGroupsNames():
      cells = []
      ptInGroup = meshFile2D.getGroupArr(-2, groupName)
      nodeInGroup = [m0D.getNodeIdsOfCell(pt[0])[0] for pt in ptInGroup]
      for cell in range(nSegment):
         cell1,cell2 = m1D.getNodeIdsOfCell(cell)
         if groupName != 'CONLIM_2222':
