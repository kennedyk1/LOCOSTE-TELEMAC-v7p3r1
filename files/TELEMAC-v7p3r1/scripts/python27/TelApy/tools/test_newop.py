...
class TestNewop(unittest.TestCase):
    ...
    def test_maccormick(self):
        ...
        self.assertEqual(error, 0)
        varx0 = (vbounds[:, 0] + vbounds[:, 1]) / 2.
        fcost, xopt = mypb.optimize(varx0, 20)
    ...
    def test_easom(self):
        ...
        varx0[0] = 2.5
        varx0[1] = 2.5
        fcost, xopt = mypb.optimize(varx0, niter=5)
    ...
    def test_eggholder(self):
        ...
        self.assertEqual(error, 0)
        varx0 = (vbounds[:, 0] + vbounds[:, 1]) / 2.
        fcost, xopt = mypb.optimize(varx0, 10)
    ...
    def test_abslinear(self):
        ...
        self.assertEqual(error, 0)
        varx0 = (vbounds[:, 0] + vbounds[:, 1]) / 2.
        fcost, xopt = mypb.optimize(varx0)
