...
Par example, 14 (2x7) rend actif les processus 2 et 7. Exception a la re
si l''entier est 1, il n''y a pas de couplage; si l''entier est 0, tous
effets suivant sont inclus:
2- BUDGET THERMIQUE, 3-..""",
                ang = """provides the ice process number with the number being defined o
basis of a multiplication of primary numbers (2, 3, 5, 7, 11, 13, ...).
For instance, 14 (2x7) activate processes 2 and 7. Exception is made for
if the number is 1, there will be no ice processes included; if the numb
0, all processes are included, as follows:
2- THERMIMAL BUDGET, 3-..""",
            ),
        ),
#       -----------------------------------
...
#   -----------------------------------
    RICE2D = FACT(statut='o',
#   -----------------------------------
#       -----------------------------------
        RICE2D_STEERING_FILE = SIMP(statut ='f',
#       -----------------------------------
            typ = 'TXM',
            defaut = '',
