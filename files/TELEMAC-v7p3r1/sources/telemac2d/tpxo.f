...
!
!>JR @ ADJOINTWARE: NO DATA STATEMENT FOR ALLOCATABLE USER TYPES ALLOWED
!      DATA TPXO_OMEGA_D/
...
!>JR @ ADJOINTWARE: ASSUMED SIZE ARRAY (*)
...
!
!>JR @ ADJOINTWARE: ALGORITHMIC DIFERENTIATION
...
!
      ...
      INTEGER, INTENT(IN)             :: KENT,KENTU,NODALCORR,T2DL93
