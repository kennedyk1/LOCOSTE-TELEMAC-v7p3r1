...
!
      TYPE(BIEF_OBJ),TARGET :: ACCROF,CN,ZFSLOP
!
...
!     30/08/2016: 48
!
      INTEGER, PARAMETER :: MAXLU_T2D = 48
!
...
!     TIME STEP
!
      DOUBLE PRECISION, TARGET :: DT, DTCAS
!
!     END TIME
!
...
!
      ! majtrac
      DOUBLE PRECISION, ALLOCATABLE :: CET_MT(:),DST_MT(:,:)
...
!     AUTOMATIC EX ARRAYS!!!!!!
      ...
      ! interpmeteo
      INTEGER :: POSTAB_IPM, NBENR_IPM
      DOUBLE PRECISION, ALLOCATABLE :: TABENT_IPM(:,:)
      DOUBLE PRECISION, ALLOCATABLE :: DUMMY_IPM(:)
      LOGICAL :: DEJA_IPM = .FALSE.
      ! interpmeteo2
      INTEGER :: POSTAB_IPM2, NBENR_IPM2
      DOUBLE PRECISION, ALLOCATABLE :: TABENT_IPM2(:,:)
      LOGICAL :: DEJA_IPM2 = .FALSE.
      ! bord_tide_misc
