...
!
     ...
     & CFL,ICIN,DTVARI,LISTIN,LEO,NORDRE)
      IMPLICIT NONE
...
!
      INTERFACE
        SUBROUTINE ENTETE(IETAPE,AT,LT,SCHEME,ORDRE)
      IMPLICIT NONE
      DOUBLE PRECISION, INTENT(IN) :: AT
...
!
     ...
     & HN,QU,QV,LT,GAMMA,NPTFR,NBOR,LIMPRO,XNEBOR,YNEBOR,KNEU,G,RAIN,
     & PLUIE,FU,FV)
      IMPLICIT NONE
...
!
     ...
     & RAIN,PLUIE,MAXADV,OPTADV_VI,IKLE,NELMAX)
      USE BIEF_DEF
      IMPLICIT NONE
...
!
     ...
     &  MESH,RAIN,PLUIE,MASS_RAIN,BILMAS,FU,FV,YACORIOL,CORIOLIS,YASMO,
...
!
      LOGICAL, INTENT(IN) :: LISTIN,DTVARI,YASMH,DIFVIT,DIFT,RAIN
      LOGICAL, INTENT(IN) :: BILMAS,YACORIOL,SPHERIC
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: MASSOU(*)
      DOUBLE PRECISION, INTENT(IN)    :: G,CFLWTD,AIRST(2,NSEG),CORIOLIS
...
!
     ...
     & T5,WDIST,NUMIN,NUMAX,YAFLULIM,FLULIM,
...
!
     ...
     &  BILMAS,FU,FV,YASMO,YACORIOL,CORIOLIS,SPHERIC,COSLAT,SINLAT,LEO)
      ...
      LOGICAL, INTENT(IN)    :: DIFVIT,DIFT,LISTIN,DTVARI,YASMH,RAIN
      LOGICAL, INTENT(IN)    :: BILMAS,YACORIOL,SPHERIC
      LOGICAL, INTENT(INOUT) :: YASMO,LEO
!
      DOUBLE PRECISION, INTENT(IN) :: PROPNU,DIFNU,GAMMA,CORIOLIS
