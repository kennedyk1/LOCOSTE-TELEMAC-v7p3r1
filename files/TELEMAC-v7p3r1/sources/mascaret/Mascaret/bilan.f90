...
1017 format(2X,'MASSE D''EAU DANS LA ZONE DE CALCUL',G16.7,'M3')
1020 format(2X,'ERREUR RELATIVE INSTANTANEE DANS LE BIEF',I3,'         : ',G16.7)
1025 format(2X,'ERREUR RELATIVE INSTANTANEE DANS LE CONFLUENT',I3,'    : ',G16.7)
1030 format(2X,'ERREUR RELATIVE INSTANTANEE GLOBALE DANS LE DOMAINE : ',G16.7)
