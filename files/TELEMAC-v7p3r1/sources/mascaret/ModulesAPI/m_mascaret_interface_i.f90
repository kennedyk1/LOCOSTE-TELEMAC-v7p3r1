...
NBARAD, IDEB, IFIN, ITEM0 , & ! variables remanentes de Mascaret passer en argument pour l'API
                   Erreur )
...
!-----------------------------------------------------------------------
   ...
   integer                   , intent(in   ) :: Phase_post_impression
   ...
   integer                   , intent(in   ) ::  num_pas,NbPasTemps
...
end module M_MASCARET_INTERFACE_I
