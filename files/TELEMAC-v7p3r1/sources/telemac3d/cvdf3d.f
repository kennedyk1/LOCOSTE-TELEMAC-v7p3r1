...
!
     ...
     & TRAV3,MESH2D,MATR2H,H,OPTBAN,TETADI,
...
!| DT             |-->| TIME STEP
!|    SETDEP      |-->| INTEGER FOR SETTLING AND DEPOSITION CONVECTION SCHEME
...
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
      INTEGER IP,K,IPTFR,IS,I,IIS,PARA,DIM1X,NELMAX
...
!
     ...
     &              NELEM3,NELMAX,NPOIN3,DT,SCHCF,LV,MSK,MASKEL%R,INFOR,
...
!
     ...
     &             NPLAN,WCC,FLUDPT,FLUDP,FLUER,IPBOT,VISCF%ADR(3)%P)
!
...
!
     ...
     &              NPLAN,OPTBAN,TETADI,YAWCC,WCC,AGGLOD,
