...
!
      IF(OPTION.NE.1.AND.OPTION.NE.2) THEN
        IF(LNG.EQ.1) THEN
          ...
          WRITE(LU,*) 'OPTION 1 CHOISIE A LA PLACE'
          WRITE(LU,*) 'POUR LE MOT-CLE :'
          WRITE(LU,*) 'OPTION DU SCHEMA POUR LA CONVECTION DES TRACEURS'
          WRITE(LU,*) 'OPTIONS POSSIBLES : 1 ET 2'
        ENDIF
        IF(LNG.EQ.2) THEN
...
!
      ...
      ENDIF
!
101   FORMAT(1X,'MURD3D_POS SCHEMA : ',1I4,'  ',1I4,' ITERATIONS')
