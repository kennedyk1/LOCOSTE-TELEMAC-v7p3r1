...
!
     ...
     & NELEM3,NELMAX,NPOIN3,DT,INFOR,CALFLU,FLUX,FLUEXT,S0F,NSCE,ISCE,
     & KSCE,SOURCES,FSCE,RAIN,PLUIE,PARAPLUIE,TRAIN,NPOIN2,MINFC,MAXFC,
...
!             HERE DFDT=H*DFDT WITH SEMI IMPLICIT H
          ...
          ENDIF
!
          CALL FLUX_IMP3D(DIM1XB,XB,NELEM3,MESH3D%NELMAX,
