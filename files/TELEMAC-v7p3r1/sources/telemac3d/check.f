...
!
     ...
     & DIM1NUL,DIM2NUL,NBOR3,NELMAX2,NPOIN2,NPTFR,NELMAX,NPTFR3,INFO)
!
!***********************************************************************
...
!-----------------------------------------------------------------------
!
      INTEGER, INTENT(IN) :: NELMAX2,NPOIN2,NPTFR,NELMAX
      ...
      INTEGER, INTENT(IN) :: IKLBOR(NELEBX,4),IKLE3(NELMAX,6)
...
!
        DO ILOC = 1,DIM2NUL
          DO IELEB=1,NELEB
              ...
              IF (N1.NE.N2) THEN
                IF (LNG.EQ.1) WRITE(LU,51) IELEB,ILOC,N1,N2
                IF (LNG.EQ.2) WRITE(LU,52) IELEB,ILOC,N1,N2
                IERR = IERR + 1
              ENDIF
          ENDDO
        ENDDO
