...
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
      INTEGER IELM,I,J,K,ITRAC,I1,I2,I3,IELEM,NPOINMAX,ERR
      INTEGER OLD_NPTFR
...
!
      IELM = 11
!
      WRITE(LU,*) 'CALL VOISIN'
!     JMH: HERE NBOR NOT INITIALISED, BUT USED ONLY IF NCSIZE.GT.1
...
!
     ...
     &                CHBORD,TBOR,ATBOR,BTBOR)
!       FIXME: SHOULD BE GENERIC
!       JMH: COULD BE DONE ONCE AFTER THE LAST REFINEMENT, WITH FINEMESH%NPOIN
