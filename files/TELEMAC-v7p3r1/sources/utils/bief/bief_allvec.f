...
!
        ...
        ELSEIF(SIZE(VEC%R).LT.VEC%MAXDIM1*VEC%DIM2) THEN
          IF(LNG.EQ.1) THEN
            WRITE(LU,*) 'DESALLOCATION REALLOCATION DE %R DE ',
...
!
        ...
        ELSEIF(SIZE(VEC%I).LT.VEC%MAXDIM1*VEC%DIM2) THEN
          IF(LNG.EQ.1) THEN
            WRITE(LU,*) 'REALLOCATION DE %I DE ',VEC%NAME
            WRITE(LU,*) 'ANCIENNE TAILLE : ',SIZE(VEC%I)
            WRITE(LU,*) 'NOUVELLE TAILLE : ',VEC%MAXDIM1*VEC%DIM2
          ENDIF
          IF(LNG.EQ.2) THEN
