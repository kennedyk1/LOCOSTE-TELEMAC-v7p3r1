...
!
      ...
      IF(IOPT1.LT.0.OR.IOPT1.GT.3) THEN
        IF(LNG.EQ.1) THEN
          WRITE(LU,*) 'CVTRVF_NERD : OPTION IOPT1 INCONNUE : ',IOPT1
        ENDIF
        IF(LNG.EQ.2) THEN
      ...
      IF(IOPT2.NE.0.AND.IOPT2.NE.1) THEN
        IF(LNG.EQ.1) THEN
          WRITE(LU,*) 'CVTRVF_NERD : OPTION IOPT2 INCONNUE : ',IOPT2
        ENDIF
        IF(LNG.EQ.2) THEN
...
!
      ...
      ENDIF
!
201   FORMAT('CVTRVF_NERD (SCHEMA NERD, 13 OU 14) : ',1I3,' ITERATIONS')
