...
!
     ...
     &                    NELMAX,IELM,W,INIT,LV,MSK,MASKEL,NDP,ERRX)
          USE BIEF_DEF
          USE DECLARATIONS_SPECIAL
          IMPLICIT NONE
          DOUBLE PRECISION, INTENT(INOUT)::X(*)
...
!
     ...
     &   SECU,OPT,WITHABS)
          ...
          DOUBLE PRECISION, INTENT(IN)    :: H(NPOIN),MAS(NPOIN),
     &                                       SMH(NPOIN)
...
!
     ...
     &                    X,Y,Z,IKLE,NELEM,NELMAX,INCHYD,NPOIN2)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
...
!
        SUBROUTINE MT15PP
     &(T,XM,PPQ,XMUL,SF,F,ZPT,SURFAC,IKLE,NELEM,NELMAX)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      INTEGER, INTENT(IN) :: NELEM,NELMAX
...
!
     ...
     &                TARGET,OPTIONAL :: FLULIMEBE(MESH%NELMAX,3)
        END SUBROUTINE
!
...
!
     ...
     &    TYP_ELEM,NELEM,NPTFR,NPTIR,NDP,NPLAN,TYP_BND_ELEM,NELEBD)
          CHARACTER(LEN=8), INTENT(IN) :: FFORMAT
...
!
     ...
     &(FFORMAT,NFILE,MESH,NPLAN,DATE,TIME,T1,T2,NGEO,GEOFORMAT,LATLONG)
        USE BIEF_DEF
      CHARACTER(LEN=8) ,     INTENT(IN) :: FFORMAT
...
!
     ...
     & IOPT2,FLBORTRA,SURNIT,RAIN,PLUIE,TRAIN,PHI_I,OPTADV,TETAFCOR,
     & MASS_BAL,MASSOU)
      USE BIEF_DEF
      USE DECLARATIONS_SPECIAL
      IMPLICIT NONE
      INTEGER, INTENT(IN)             :: NPOIN,NPTFR,KDIR,KDDL
      INTEGER, INTENT(IN)             :: OPTSOU,IOPT2,OPTADV
      INTEGER, INTENT(IN)             :: NBOR(NPTFR),LIMTRA(NPTFR)
