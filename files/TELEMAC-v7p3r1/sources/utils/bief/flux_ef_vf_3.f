...
!                    ***********************
!
     &(PHIEL,NELEM,NELMAX,ELTSEG,ORISEG,FXMATPAR,NSEG,IKLE,IOPT,NPOIN,
...
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
      INTEGER, INTENT(IN)             :: NELEM,NELMAX,NPOIN,IOPT,NSEG
      ...
      DOUBLE PRECISION, INTENT(IN)    :: FLULIMEBE(NELMAX,3)
