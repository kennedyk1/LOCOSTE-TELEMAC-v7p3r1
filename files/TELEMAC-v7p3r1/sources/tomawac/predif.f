...
!
          CALL DIFFRAC
     &  (CX%R,CY%R,CT%R,XK,CG,FREQ,COSTET,SINTET,
     &   NPOIN2,NPLAN,IFF,NF,PROINF,SPHE,A,DFREQ,
     &   F,CCG,DIV,DELTA,DDX,DDY,EPS,NBOR,NPTFR,XKONPT,
     &   RX,RY,RXX,RYY,NEIGB,NB_CLOSE,DIFFRA,MAXNSP,FLTDIF,OPTDER)
!
          DO IEL=1,NELEM2
            I1=IKLE2(IEL,1)
            I2=IKLE2(IEL,2)
...
!   IT IS NO LONGER POSSIBLE TO SEPARATE THE FREQUENCIES OUT
        IF(LNG.EQ.1) THEN
          ...
          WRITE(LU,*) ' VARIABLE                              '
          WRITE(LU,*) ' IL FAUT CHOISIR ENTRE LE COURANT      '
          WRITE(LU,*) ' ET LA DIFFRACTION                     '
          WRITE(LU,*) '***************************************'
        ELSE
          WRITE(LU,*) ''
          WRITE(LU,*) '***************************************'
