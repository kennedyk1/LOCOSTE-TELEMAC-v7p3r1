...
!
! TF:      
!    TRUC : On indexe par un les variables rentrantes car on les aurait aussi par 
!    declaration tomawac.  CG1, XK1, CGSUC1, et  FX1,FY1 ne devraient pas venir par l'appel
!    On peut faire plus propre mais il y a peut être qqchse de caché !!!         
!    TRICK: variables CG1, XK1, CGSUC1, and  FX1,FY1 should come from declaration_telemac
!    without the index 1 and not from the call. we could make it cleaner
!    but there night be something hidden.
