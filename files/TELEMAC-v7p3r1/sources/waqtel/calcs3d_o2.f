...
!+        17/01/2018
!+        V7P3
!+        One source term has to be computed explicitly, the 2 others
!+        implicitly like in the versions before the new indexing of
!+        tracers.
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!
     ...
     &  WAQTR,RANKTR,IND_T,IND_O2,IND_OL,IND_NH4
...
!     SURFACE SOURCES
      DO I=1,NPOIN2
        J=(NPLAN-1)*NPOIN2+I
        TEXP%ADR(IND_O2)%P%R(J)= T31%R(J)*K2%R(I)*
     &          MAX((T21%R(I)-TN%ADR(IND_O2)%P%R(J)),0.D0)-
