...
!
      INTEGER  WAQTR
!
!     INDICES OF TRACERS ADDED WHEN USING WAQPROCESS
!
...
!
!##> JR @ ADJOINTWARE: MODULE VARIABLES WITH DEFAULT INITIALISATION
!     FOR USER TYPE COMPONENTS (IN AD VECTOR MODE) MUST BE SAVED
     ...
     &     CFAER, CCSEDIM, EVAPOR, RO0, TAIR_VALUE, EXTCAED2, FLUXAED2,
     &     DEJA_CA,DEJA_SW
!##< JR @ ADJOINTWARE
!
