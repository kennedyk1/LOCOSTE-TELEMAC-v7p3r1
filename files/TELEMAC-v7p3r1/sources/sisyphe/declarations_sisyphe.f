...
!     TYPE COMPONENTS MUST BE SAVED
      SAVE :: AT0, DT, TIME_FLUSEC2, MASFIN, RC, XMVE, XMVS, XKV, GRAV,
     &     SFON, VCE, TETA, HMIN, BETA, DELT, PMAREE, TPREC, PHI0, ZERO,
     &     CRIT_CFD, FRACSED_GF, CS0, MASSOU, CSF_SABLE, XWC, AC,
     &     TETA_SUSP, XKX, XKY, PHISED, BETA2, HIDI, FD90, FDM, AVA0,
     &     ELAY0, VOLTOT, VITCD, VITCE, MASED0, MASINI, MASTEN, MASTOU,
     &     MASTCP, MASS0, MASDEP, MASDEPT, MASVT, MASV0, MASST, LS0,
     &     KSPRATIO, KARIM_HOLLY_YANG, KARMAN, PARTHENIADES, CMAX, PI,
     &     MPM, ALPHA, MOFAC, BIJK, CONC_VASE, TRANS_MASS, TOCE_VASE,
     &     TOCE_SABLE, CONC_GEL, COEF_N, CONC_MAX, MASBED0, MASBED,
     &     HMIN_BEDLOAD, TL2_RFC, SLVSED, SLVTRA, TL1_RFC, LASTAT_RFC,
     &     VCUMU, MASS_GF
!##<JR @ ADJOINTWARE
!
