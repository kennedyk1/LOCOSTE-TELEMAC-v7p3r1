...
!
      ...
      INTEGER, INTENT(IN) :: PROVEL(NPTFR)
...
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
      INTEGER K,MSK8,IFRLIQ,YADEB(MAXFRO),IERR,ITRAC,IFR,N,IELEB,KP1,I
!
...
!
      ...
      IF(LT.EQ.1) THEN
        DO K=1,NPTFR
          ...
          IF(I.EQ.102.OR.I.EQ.98.OR.
     &       I.EQ.94.OR.I.EQ.90.OR.
     &       I.EQ.86.OR.I.EQ.82) THEN
            DO ITRAC=1,NTRAC
              TBOR%ADR(ITRAC)%P%R(K) = 1.D0
            ENDDO
          ENDIF
        ENDDO
      ENDIF
